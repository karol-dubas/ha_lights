# Source: https://github.com/nathanbabcock/nightlight-cli/blob/main/src/nightlight.py
...
class NightLight:
    ...
    def supported(self) -> bool:
        ...
        try:
            winreg.OpenKey(
                winreg.HKEY_CURRENT_USER, self._state_key_path, 0, winreg.KEY_READ
            )
            winreg.OpenKey(
                winreg.HKEY_CURRENT_USER, self._settings_key_path, 0, winreg.KEY_READ
            )
            return True
    ...
    def toggle(self) -> None:
        ...
        try:
            key = winreg.OpenKey(
                winreg.HKEY_CURRENT_USER, self._state_key_path, 0, winreg.KEY_SET_VALUE
            )
